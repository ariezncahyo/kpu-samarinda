                    ...
                    <div class="col-md-10 col-md-offset-1">
                        <div class="block-flat">
                            <div class="step-content">
                                {{ Form::open(array('route' => 'admin.berita.store', 'class' => 'form-horizontal group-border-dashed')) }}
                                    <div class="form-group no-padding">
                                        <div class="col-sm-7">
                                            <h3 class="hthin">Buat Berita Baru</h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group {{ ($errors->has('isi')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="input-block-level" id="summernote" name="isi" rows="18">Tulis isi berita</textarea>
                                            @if($errors->has('isi'))
