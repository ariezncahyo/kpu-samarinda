  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          ...
          <ul class="nav navbar-nav navbar-right">
            <li><a href="{{ route('admin') }}" target="_blank"><i class="glyphicon glyphicon-user"></i></a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="page-header" id="banner" style="margin: 25px 0 25px;">
        <div class="row">
          <div style="margin-top:-158px;transform:rotate(15deg);-moz-transform:rotate(15deg);-webkit-transform:rotate(-15deg);position:absolute;opacity:0.2;">
            <img src="http://localhost:8000/aset/kpu/logo.png">
          </div>
          <div class="col-lg-12 text-right">
            <h1>KPU Kota Samarinda</h1>
            <p class="lead" style="margin-top:-10px;font-weight:100;line-height: 1;">
              Komisi Pemilihan Umum Provinsi Kalimantan Timur
            </p>
            <p style="margin-top: 0px;">
              <i class="glyphicon glyphicon-map-marker"></i>  Jl. Basuki Rahmat No. 02 Samarinda
              <i class="glyphicon glyphicon-phone"></i> Telp : (0541) 743995
              <i class="glyphicon glyphicon-phone-alt"></i> Fax : (0541) 747138
          </div>
        </div>
      </div>
