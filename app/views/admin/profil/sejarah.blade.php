            ...
            <div class="container-fluid">
                <div class="page-head">
                    <ol class="breadcrumb">
                      ...
                      <li class="active">Sejarah Instansi</li>
                    </ol>
                </div>      
            <div class="cl-mcont">
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="alert alert-warning alert-white rounded">
                            ...
                            <strong>Perhatian!</strong> {{ $errors->first('sejarah') }}
                        </div>
                        @endif
                        <div class="block-flat">
                        	{{ Form::open(array('route' => 'admin.sejarah', 'class' => 'form-horizontal group-border-dashed')) }}
                        	<div class="header">	
								<button class="btn btn-primary pull-right">Simpan Perubahan <i class="fa fa-caret-right"></i></button>						
								<h3>Sejarah Instansi</h3>
							</div>
							<div class="content">
								<div class="form-group">
                                    <div class="col-sm-12">
                                        <textarea class="input-block-level" id="summernote" name="sejarah">{{ $temp->sejarah }}</textarea>
                                    </div>
                                </div>
							</div>
							{{ Form::close() }}
