					...
					<div class="col-md-12">
						...
						<div class="block-flat">
							...
							<div class="header">	
								...
								@endif
								<h3>Daftar Pemilih Sementara</h3>
							</div>
							<div class="content">
										...
										<tbody>
											@foreach ($penduduk as $penduduk)
												<tr>
													...
													<td>{{ Form::checkbox('sah', $penduduk->sah_kelurahan, ($penduduk->sah_kelurahan === 1) ? 'checked' : '', array('disabled' => 'disabled')) }}</td>
													<td>{{ Form::checkbox('sah', $penduduk->sah_kecamatan, ($penduduk->sah_kecamatan === 1) ? 'checked' : '', array('disabled' => 'disabled')) }}</td>
