                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="block-flat">
                            <div class="step-content">
                                {{ Form::model($kecamatan, array('method' => 'PATCH', 'route' => array('admin.kecamatan.update', $kecamatan->id), 'class' => 'form-horizontal group-border-dashed')) }}
                                    <div class="form-group no-padding">
                                        <div class="col-sm-7">
                                            <h3 class="hthin">Ubah Informasi Kecamatan</h3>
                                        </div>
                                    </div>
