                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="block-flat">
                            <div class="step-content">
                                {{ Form::model($penduduk, array('method' => 'PATCH', 'route' => array('admin.penduduk.update', $penduduk->id), 'class' => 'form-horizontal group-border-dashed')) }}
                                    ...
                                    <div class="form-group {{ (($errors->has('tempat_lahir')) || ($errors->has('tanggal_lahir'))) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-4">
                                            {{ Form::text('tanggal_lahir', $penduduk->tanggal_lahir, array('class' => 'form-control', 'data-mask' => 'date', 'placeholder' => 'DD/MM/YYYY')) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            {{ Form::text('id_tps', null, array('class' => 'form-control', 'placeholder' => 'TPS')) }}
                                        </div>
                                    </div> 
                                    <div class="form-group {{ ($errors->has('id_kelurahan')) ? 'has-error' : '' }}">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            @if($errors->has('id_kelurahan'))
                                                <small><span class="help-block text-center">{{ $errors->first('id_kelurahan') }}</span></small>
                                            @endif
                                        </div>
                                    </div>     
                                    <div class="form-group">
